...
func main() {
	...
	router.HandleFunc("/api/v1/file", GetFiles).Methods("GET")
	router.HandleFunc("/api/v1/file/{id:[0-9]+}", GetFileByID).Methods("GET")
	router.HandleFunc("/api/v1/file", UploadFile).Methods("POST")
	router.HandleFunc("/api/v1/file/{id:[0-9]+}/download", DownloadFile).Methods("GET")
	router.HandleFunc("/api/v1/file/{id:[0-9]+}", DeleteFile).Methods("DELETE")
